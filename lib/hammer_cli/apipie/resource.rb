module HammerCLI::Apipie
  ...
  module Resource
    ...
    def resource_config
      ...
      config[:username] = context[:username] || ENV['FOREMAN_USERNAME'] || HammerCLI::Settings[:username]
      config[:password] = context[:password] || ENV['FOREMAN_PASSWORD'] || HammerCLI::Settings[:password]
      config
    end
